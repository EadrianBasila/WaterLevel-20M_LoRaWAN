...
//    /* Copy contents of current seNvm */
//    SecureElementNvmData_t *_paramsNvm;
//    memcpy1(( uint8_t *)_paramsNvm,( uint8_t *)&seNvmInit, sizeof(seNvmInit));
//
//    /* Populate NVM Parameters with modification */
//    uint8_t *dev_eui_bytes = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xBB};
//    uint8_t *app_eui_bytes = {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xAA};
//    uint8_t *app_key_bytes = {0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88};
//
//    SecureElementNvmData_t *SeNvm;
//
//    for(uint8_t x = 0; x < SE_EUI_SIZE; x++){
//    	seNvmInit.SeNvmDevJoinKey.DevEui[x]  =  dev_eui_bytes[x];
//    	seNvmInit.SeNvmDevJoinKey.JoinEui[x] =  app_eui_bytes[x];
//    }
//
//    for(uint8_t x = 0; x < SE_KEY_SIZE; x++){
//    	seNvmInit.KeyList->KeyValue[x] = app_key_bytes[x];
//    }
//
//    //memcpy1(seNvmInit.SeNvmDevJoinKey.JoinEui, app_eui_bytes, SE_EUI_SIZE);
