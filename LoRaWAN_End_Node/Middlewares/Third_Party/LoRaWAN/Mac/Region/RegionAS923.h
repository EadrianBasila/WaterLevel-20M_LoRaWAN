 ...
 */
#define AS923_DEFAULT_DATARATE                      DR_4//DR_2

/*!
 * The minimum datarate which is used when the
 * dwell time is limited.
 */
#define AS923_DWELL_LIMIT_DATARATE                  DR_4//DR_2
 ...
 */
#define AS923_DEFAULT_TX_POWER                      TX_POWER_0//TX_POWER_0
 ...
 */
#define AS923_DEFAULT_ANTENNA_GAIN                  2.15f//2.15f
