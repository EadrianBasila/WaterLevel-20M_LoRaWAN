...
/*!
 * External Devnonce Variable Access
 */
extern int getDevnonce;

/*!
 * External Flash Address Variable Access
 */
extern uint32_t getAddress;

/*!
 * External Flash Variables Access
 */
#define DEVNONCE_FLASH_ADDRESS    	((uint32_t)0x0803B7FF)
#define DEFAULT_DEVNONCE 			0
#define FLASH_BASE  			   	((uint32_t)0x0803B7FF)
